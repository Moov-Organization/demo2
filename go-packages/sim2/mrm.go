...
const MoovRideManagerABI = "[{\"constant\":true,\"inputs\":[{\"name\":\"\",\"type\":\"address\"}],\"name\":\"rides\",\"outputs\":[{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"uint256\"},{\"name\":\"rideStatus\",\"type\":\"uint8\"},{\"name\":\"carAddress\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"getRideStatus\",\"outputs\":[{\"name\":\"\",\"type\":\"uint8\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"getLocations\",\"outputs\":[{\"name\":\"\",\"type\":\"string\"},{\"name\":\"\",\"type\":\"string\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"finishRide\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"chosenRider\",\"type\":\"address\"}],\"name\":\"acceptRideRequest\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"getCarAddress\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"newRideRequest\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"getAvailableRides\",\"outputs\":[{\"name\":\"\",\"type\":\"address[]\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"moovCoin\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"cancelRideRequest\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"getBalance\",\"outputs\":[{\"name\":\"balance\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"name\":\"moovCoinAddress\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"rider\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"from\",\"type\":\"string\"},{\"indexed\":false,\"name\":\"to\",\"type\":\"string\"},{\"indexed\":false,\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"NewRideRequest\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"rider\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"car\",\"type\":\"address\"}],\"name\":\"RideAccepted\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"name\":\"rider\",\"type\":\"address\"},{\"indexed\":false,\"name\":\"car\",\"type\":\"address\"}],\"name\":\"RideFinished\",\"type\":\"event\"}]"

// MoovRideManagerBin is the compiled bytecode used for deploying new contracts.
const MoovRideManagerBin = ``
...
//
// Solidity: function getLocations(addr address) constant returns(string, string)
func (_MoovRideManager *MoovRideManagerCaller) GetLocations(opts *bind.CallOpts, addr common.Address) (string, string, error) {
	var (
		ret0 = new(string)
		ret1 = new(string)
	)
...
//
// Solidity: function getLocations(addr address) constant returns(string, string)
func (_MoovRideManager *MoovRideManagerSession) GetLocations(addr common.Address) (string, string, error) {
...
//
// Solidity: function getLocations(addr address) constant returns(string, string)
func (_MoovRideManager *MoovRideManagerCallerSession) GetLocations(addr common.Address) (string, string, error) {
	return _MoovRideManager.Contract.GetLocations(&_MoovRideManager.CallOpts, addr)
}
...
// Rides is a free data retrieval call binding the contract method 0x1e8d3dcb.
//
// Solidity: function rides( address) constant returns(from string, to string, amount uint256, rideStatus uint8, carAddress address)
func (_MoovRideManager *MoovRideManagerCaller) Rides(opts *bind.CallOpts, arg0 common.Address) (struct {
	From       string
	To         string
	Amount     *big.Int
	RideStatus uint8
	CarAddress common.Address
}, error) {
	ret := new(struct {
		From       string
		To         string
	...
	out := ret
	err := _MoovRideManager.contract.Call(opts, out, "rides", arg0)
	return *ret, err
}
...
//
// Solidity: function rides( address) constant returns(from string, to string, amount uint256, rideStatus uint8, carAddress address)
func (_MoovRideManager *MoovRideManagerSession) Rides(arg0 common.Address) (struct {
	From       string
	To         string
	Amount     *big.Int
	RideStatus uint8
	...
	return _MoovRideManager.Contract.Rides(&_MoovRideManager.CallOpts, arg0)
}

// Rides is a free data retrieval call binding the contract method 0x1e8d3dcb.
//
// Solidity: function rides( address) constant returns(from string, to string, amount uint256, rideStatus uint8, carAddress address)
func (_MoovRideManager *MoovRideManagerCallerSession) Rides(arg0 common.Address) (struct {
	From       string
	To         string
	Amount     *big.Int
	RideStatus uint8
